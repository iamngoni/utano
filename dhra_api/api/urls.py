...
urlpatterns = [
    ...
    path("lab/", include("api.views.lab.urls"), name="Lab URLS"),
    path("patient/", include("api.views.patient.urls"), name="Patient URLS"),
    path("payments/", include("api.views.payments.urls"), name="Payments URLS"),
    path("pharmacy/", include("api.views.pharmacy.urls"), name="Pharmacy URLS"),
